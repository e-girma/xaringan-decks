...
which_won_where <- plot(gge_symmetrical, type=3, #<<
                        ...
                        size.text.win = 5, plot_theme = theme_xaringan(css_file =  "C:/Users/eruph/Documents/git repos for r/xaringan-decks/GxE-June2022/xaringan-themer.css",
  text_font_size = 12,
  title_font_size = 14)) +
  ylim(-60,25)
...
compare_two_gen <- plot(gge_symmetrical, type=9, sel_gen1 = "15", sel_gen2 = "69",  #<<
                         ...
                         size.text.win = 6, plot_theme = theme_xaringan(css_file =  "C:/Users/eruph/Documents/git repos for r/xaringan-decks/GxE-June2022/xaringan-themer.css",
  text_font_size = 12,
  title_font_size = 14)) +
  ylim(-60,30)
