...
Basic Biplot is a PC2 vs PC1 plot. Each environment will have a vector connected to the origin. The angle between environments gives you information about the correlation between the environments. 
...
plot(gge_model_gen, type =7, sel_gen = "87")
...
```{r ammi-anova, highlight.output = 1:8}
ammi$yield$ANOVA
```
]
